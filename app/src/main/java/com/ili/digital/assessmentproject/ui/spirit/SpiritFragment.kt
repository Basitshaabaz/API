...
import com.ili.digital.assessmentproject.databinding.FragmentSpiritBinding
...
class SpiritFragment : Fragment(), MenuProvider {
    ...
    private val viewModel: SpiritFragmentViewModel by viewModels()
    ...
    private fun observers() {
        viewLifecycleOwner.lifecycleScope.launch {
            getSpirit()
            viewModel.spiritState.collect { screenState ->
    ...
    private fun getSpirit() {
        searchMode = false
        viewLifecycleOwner.lifecycleScope.launch { viewModel.getSpirit() }
    }
    ...
    companion object {
        ...
        fun newInstance(): SpiritFragment {
            return SpiritFragment()
        }
    }
}